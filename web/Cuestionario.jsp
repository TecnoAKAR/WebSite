...
<html>
    ...
    <body>
        ...
        %>
                        <script>
                            //alert("La posibilidad de que tenga el síndrome de asperger es: baja." );
                            Swal.fire({
                                icon: 'success',
                                title: 'La posibilidad de que tenga síndrome de asperger es: baja.',
        ...
        %>
                        <script>
                            //alert("La posibilidad de que tenga el síndrome de asperger es: media." );
                            Swal.fire({
                                icon: 'success',
                                title: 'La posibilidad de que tenga síndrome de asperger es: media.',
                                text: 'En caso de tener alguna duda consulte a un especialista.',
                                footer: '<button type="button" class="btn btn-light"> <a href="index.jsp">Volver al index.</a> </button>'
                              });
                        </script>
        ...
        %>
                        <script>
                            //alert("La posibilidad de que tenga síndrome de asperger es: media alta." );
                            Swal.fire({
                                icon: 'warning',
                                title: 'La posibilidad de que tenga síndrome de asperger es: media alta.',
        ...
        %>
                        <script>
                            //alert("La posibilidad de que tenga el síndrome de asperger es: muy alta." );
                            Swal.fire({
                                icon: 'warning',
                                title: 'La posibilidad de que tenga síndrome de asperger es: muy alta.',
                                text: 'Le recomendamos visitar a un profesional.',
                                footer: '<button type="button" class="btn btn-light"> <a href="index.jsp">Volver al index.</a> </button>'
                              });
                        </script>
