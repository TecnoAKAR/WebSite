    ...
    <body>
        <div id="divC">
            <div class="card text-bg-dark mb-3" style="max-width: 20rem;">
                ...
                <div class="card-body">
                    <h4 class="card-title"> Sin sesión iniciada </h4>
                    <p class="card-text">Inicie sesión para ingresar a esta página.</p>
                    <a href="login.jsp"> <button type="button" class="btn btn-light">Iniciar sesión</button> </a>
                </div>
            </div>
        </div>
